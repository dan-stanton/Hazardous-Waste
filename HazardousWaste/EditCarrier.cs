...
{
    public partial class EditCarrier : Form
    {
        ...
        private void EditCarrier_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "SELECT TOP 1 * FROM Carriers WHERE Name = '" + Global.selected_id + "'";
        ...
        private void EditCreate_Click(object sender, EventArgs e)
        {
            if (IsFormattingOk())
            {
                ...
                if (String.Equals(EditCreate.Text, "Create")) query = "INSERT INTO Carriers (Name, Address1, Address2, Address3, Address4, Postcode, Permit, Deleted) VALUES('" + SiteName.Text + "', '" + AdressLine1.Text + "', '" + AdressLine2.Text + "', '" + AdressLine3.Text + "', '" + AdressLine4.Text + "', '" + Postcode.Text + "', '" + Permit.Text + "', 0)";
                else query = "UPDATE Carriers SET Name = '" + SiteName.Text + "', Address1 = '" + AdressLine1.Text + "', Address2 = '" + AdressLine2.Text + "', Address3 = '" + AdressLine3.Text + "', Address4 = '" + AdressLine4.Text + "', Postcode = '" + Postcode.Text + "', Permit = '" + Permit.Text + "', Deleted = '" + temp + "' WHERE Name = '" + Global.selected_id + "'";
                command = new SqlCommand(query, con);
